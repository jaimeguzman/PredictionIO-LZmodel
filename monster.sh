...
echo -e "\e[34m''PLEASE WAIT...\e[39m"
echo "\n"
# echo $'\e[31mHello World\e[0m'
echo -e "First Command Execute \e[33m PIO BUILD"
echo -e "\e[31mBUILDING PROCESS.... please wait... \e[0m \e[39m"
echo "\n"
...
echo "\n"
echo -e "Second Command Execute \e[33m PIO TRAIN"
echo -e "\e[31mTRAINING PROCESS.... please be patience.\e[39m"
echo "\n"

# /Users/jguzman/PredictionIO/bin/pio train -- --driver-memory 8G --executor-memory 8G --verbose
pio train -- --driver-memory 240G --executor-memory 240G
wait
...
pio deploy -- --driver-memory 240G --executor-memory 240G